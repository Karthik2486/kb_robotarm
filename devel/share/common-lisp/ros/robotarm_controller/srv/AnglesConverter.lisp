...
(cl:in-package robotarm_controller-srv)
...
(cl:defmethod cl:initialize-instance :after ((m <AnglesConverter-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'AnglesConverter-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name robotarm_controller-srv:<AnglesConverter-request> is deprecated: use robotarm_controller-srv:AnglesConverter-request instead.")))

(cl:ensure-generic-function 'base-val :lambda-list '(m))
(cl:defmethod base-val ((m <AnglesConverter-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader robotarm_controller-srv:base-val is deprecated.  Use robotarm_controller-srv:base instead.")
  (base m))

(cl:ensure-generic-function 'shoulder-val :lambda-list '(m))
(cl:defmethod shoulder-val ((m <AnglesConverter-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader robotarm_controller-srv:shoulder-val is deprecated.  Use robotarm_controller-srv:shoulder instead.")
  (shoulder m))

(cl:ensure-generic-function 'elbow-val :lambda-list '(m))
(cl:defmethod elbow-val ((m <AnglesConverter-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader robotarm_controller-srv:elbow-val is deprecated.  Use robotarm_controller-srv:elbow instead.")
  (elbow m))

(cl:ensure-generic-function 'gripper-val :lambda-list '(m))
(cl:defmethod gripper-val ((m <AnglesConverter-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader robotarm_controller-srv:gripper-val is deprecated.  Use robotarm_controller-srv:gripper instead.")
  (gripper m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<AnglesConverter-request>)))
  ...
  "robotarm_controller/AnglesConverterRequest")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'AnglesConverter-request)))
  "Returns string type for a service object of type 'AnglesConverter-request"
  "robotarm_controller/AnglesConverterRequest")
...
(cl:defmethod cl:initialize-instance :after ((m <AnglesConverter-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'AnglesConverter-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name robotarm_controller-srv:<AnglesConverter-response> is deprecated: use robotarm_controller-srv:AnglesConverter-response instead.")))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<AnglesConverter-response>)))
  ...
  "robotarm_controller/AnglesConverterResponse")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'AnglesConverter-response)))
  "Returns string type for a service object of type 'AnglesConverter-response"
  "robotarm_controller/AnglesConverterResponse")
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'AnglesConverter)))
  ...
  "robotarm_controller/AnglesConverter")