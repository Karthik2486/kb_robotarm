...
#include "robotarm_controller/robotarm_interface.h"
#include <std_msgs/UInt16MultiArray.h>
#include "robotarm_controller/AnglesConverter.h"
            ...
            names_{"joint_1", "joint_2", "joint_3", "joint_4"}
{
    ...
    hardware_srv_ = pnh_.serviceClient<robotarm_controller::AnglesConverter>("/radians_to_degrees");
    
    ROS_INFO("Starting Robotarm Hardware Interface...");
...
{    
    ...
    // to the Arduino convention and then publishes the convertedrobotarm::AnglesConverter srv;
    robotarm_controller::AnglesConverter srv;
...
{
    ros::init(argc, argv, "robotarm_interface_node");
    ros::NodeHandle nh;
